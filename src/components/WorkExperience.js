  ...
  return (
    <div className="projects">
      ...
      <p>
        ...
        Vision API, Lightroom, FileZilla, Photoshop, Woo-commerce, Product CSV,
        W3 Total Cache.
      </p>
      <hr />
      <h2>
      ...
      <p>
        <em>
          React Application which Creates, Reads, Updates and Deletes Accounts
          using a Rest API&nbsp;
        </em>
      </p>
      <ul>
      ...
      <p>
        <strong>Technologies &amp; Tools</strong>: API, JSON, React, Animations,
        gulp, Sass, Photoshop
      </p>
      <hr />
      <h2>
      ...
      <p>
        <strong>Technologies &amp; Tools</strong>: Jekyll, Ruby, Git, Liquid,
        Themes
      </p>
      <hr />
      <h2>
      ...
      <p>
        <strong>Technologies &amp; Tools</strong>: HTML5, LESS, Npm, Webpack,
        Gulp, Typescript, Promises, Api, Axios, HTTP, Moment.js, Git, Bootstrap,
        JSON.
      </p>
      <hr />
      <h2>
      ...
      <p>
        <em>
          A commercial website advertising the services of a portable recording
          studio, its playful approach includes P5js of different shapes of
          sound waves involved in recording.&nbsp;
        </em>
      </p>
      ...
      <p>
        <strong>Technologies &amp; Tools</strong>: JavaScript, CSS, Html, p5.js,
        git-pages, Visual Studio Code.
      </p>
      <hr />
      ...
      <p>
        ...
        p5js, API, webpack, threex, draco-compression, basis compression, gsap,
        moment.js, XML, RSS, Photoshop, wordpress.
      </p>
    </div>
  );
}
